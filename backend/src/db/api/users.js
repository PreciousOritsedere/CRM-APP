...
module.exports = class UsersDBApi {
  ...
  static async findBy(where, options) {
    ...
    output.email_campaigns_owner = await users.getEmail_campaigns_owner({
      transaction,
    });
    ...
    output.reports_owner = await users.getReports_owner({
      transaction,
    });

    output.tasks_assignee = await users.getTasks_assignee({
      transaction,
    });
