...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'first_name' && props.sortDirection]"
        @click="sort('first_name')"
      >FirstName</th>

      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'last_name' && props.sortDirection]"
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'industry' && props.sortDirection]"
        @click="sort('industry')"
      >Industry</th>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'tags' && props.sortDirection]"
        @click="sort('tags')"
      >Tags</th>
    ...
    <tbody>
      ...
      >
        ...
        />
              ...
              <td data-label="tags">
                  <span
                    v-for="(i, idx) in dataFormatter.tagsManyListFormatter(client.tags)"
                    :key="idx + client.tags"
                    class="block"
                  >
                      {{ i }}
