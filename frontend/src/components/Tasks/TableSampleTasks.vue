...
<template>
  ...
  <table>
    <thead>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'due_date' && props.sortDirection]"
        @click="sort('due_date')"
      >DueDate</th>
      ...
      <th
        :class="['sortable uppercase text-sm font-normal text-pavitra-600', props.sortTitle === 'assignee' && props.sortDirection]"
        @click="sort('assignee')"
      >Assignee</th>
      ...
      >
        ...
        />
              ...
              <td data-label="due_date">
                {{ dataFormatter.dateTimeFormatter(client.due_date) }}
              </td>    
              ...
              <td data-label="assignee">
                {{ dataFormatter.usersOneListFormatter(client.assignee) }}
              </td>
