...
import TableSampleTasks from '@/components/Tasks/TableSampleTasks.vue'
...
const onConfirmCsv = async () => {
  if (csvFile.value) {
    ...
    tasksStore.fetch(null, query.value);
...
<CardBoxModal
  ...
  <SectionHeroBar>Tasks</SectionHeroBar>
  <SectionMain>
    <BaseButtons>
      <BaseButton
        color="default"
  ...
  <SectionMain>
  <a class="text-blue-500 hover:text-blue-600 active:text-blue-700 mb-3 block" :href="externalLink">API documentation for tasks</a>
    ...
    <CardBox
      ...
      has-table
    >
      <TableSampleTasks checkable :sortTitle="sortTitle" :sortDirection="sortDirection" @sort="sortTable($event)" />
    </CardBox>
